...
$html = '<div>
			<h3 style="text-align:center;">รายงาน Vat ซื้อ <br/>ประจำเดือน '.$this->fn->q('time')->month( sprintf("%01d", $this->month), true ).' '.($this->year+543).'</h3>
		</div>
		<div>
		<table width="100%">
			<thead>
				<tr style="background-color:Violet;">
					...
					<th width="10%" style="font-weight: bold;">Code</th>
...
if( $this->results["total"] > 45 ) {
	$total_list = $this->results["total"];
	// $total_page = ceil( $this->results["total"] / 45 );
}
